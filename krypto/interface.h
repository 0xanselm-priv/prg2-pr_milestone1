...
public:
    ...
    vector < bool, vector < vector<int> > > prog2(string, string, string, bool); // returns whether to exit the program or return to the menu
    vector < bool, vector < vector<int> > > prog3(string, string, string, bool);
    vector < bool, vector < vector<int> > > prog4(string, string, string, bool);
